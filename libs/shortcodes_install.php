...
function wpestate_add_plugin($plugin_array) {   
    ...
    $plugin_array['contact_us_form']            = get_template_directory_uri() . '/js/shortcodes.js';
    return $plugin_array;
}
    ...
    if( !function_exists('wpestate_vc_shortcodes')):
        ...
        vc_map(
            array(
             ...
             vc_map( array(
                "name" => esc_html__( "Dislay Categories","wpestate"),//done
                "base" => "places_list",
                "class" => "",
            ...
            vc_map(
                ...
                "params" => array(
                    ...
                    , array(
                        ...
                        "value"         =>  $testimonials_type,
                        "description"   =>  __("What types of slider do you use?","wpestate")
                    ),
