	...
	function widget($args, $instance){
        ...
        function custom_fields_widget($adv_search_what,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$adv_search_how,$adv_search_label,$select_county_state_list){
            ...
            foreach($adv_search_what as $key=>$search_field){
                wpestate_show_search_field('sidebar',$search_field,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$key,$select_county_state_list, $select_sub_categories_list);
            } 
