...
function wpestate_estate_property_design_agent_contact($attributes,$content = null){
    ...
    if ( $contact_form_7_agent==''){ 
        ...
        <textarea id="agent_comment" name="comment" class="form-control" cols="45" rows="8" aria-required="true">'.__("Im interested in ","wpestate").'[ '.get_the_title($propid).' ]</textarea>
