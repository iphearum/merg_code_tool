...
function estate_sidebar_meta()
{
    ...
    add_meta_box('wpestate-header', __('Appea   rance Options', 'wpestate'), 'estate_header_function', 'estate_property', 'normal', 'low');
}
...
function estate_header_function()
{
    ...
    if (get_post_type($post->ID) =='estate_property') {
        ...
        $option = '';
        // custom 2020/04/27
        $option.='<option value="yes" selected="selected" >yes</option>';
        // end custom
    ...
    $header_select  =   '';
    // custom 2020/04/27
    $header_select.='<option value="none" selected="selected" >none</option>';
    // end custom
    ...
    // // custom 2020/04/27
    // $use_float_search_form_local_select.='<option value="no"';
    // $use_float_search_form_local_select.='selected="selected"';
    // $use_float_search_form_local_select.='>no</option>';
    // // end custom
    ...
    // custom 2020/04/27
    $header_transparent_select.='<option value="no" selected="selected" >no</option>';
    // end custom
    // foreach ($cache_array as $key=>$value) {
...
if (!function_exists('estate_prpg_design_option')):
    function estate_prpg_design_option()
    {
        ...
        if ('estate_property' == get_post_type()) {
            ...
            // custom 2020/04/27
            $sidebar_agent_option.='<option value="no" selected="selected" >no</option>';
            // end custom
            ...
            // custom 2020/04/27
            $local_pgpr_slider_type_symbol.='<option value="global" selected="selected" >global</option>';
            // end custom
            ...
            // custom 2020/04/27
            $local_pgpr_content_type_symbol.='<option value="global" selected="selected" >global</option>';
            // end custom
...
function estate_sidebar_box($post)
{
    ...
    // custom 2020/04/27
    $option.='<option value="global" selected="selected" >global</option>';
    // end custom
