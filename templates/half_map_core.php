...
$select_sub_categories_list    =   wpestate_get_subcategories_checkbox_list($args2); 
                                ...
                                <div class="vc_col-sm-12 wpb_column vc_column_container vc_column">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_alert wpb_content_element vc_alert_rounded wpb_alert-info wpestate_message vc_message">
                                            <div class="messagebox_text" style=""><p>'.__('[:en]Login to save search and and you will receive an email notification when new properties matching your search will be published.[:km]ចូលដើម្បីរក្សាទុកការស្វែងរកហើយអ្នកនឹងទទួលបានការជូនដំណឹងតាមអ៊ីមែលនៅពេលដែលលក្ខណៈសម្បត្តិថ្មីដែលត្រូវនឹងការស្វែងរករបស់អ្នកនឹងត្រូវបានផ្សព្វផ្សាយ។[:]','wpestate').'</p>
                                        </div>
                                        </div>
                                    </div> 
                                </div> 
...
<div class="col-md-9">
    <div id="listing_ajax_container" class="ajax-map" style="padding:0px !important;"> 
        <?php
        $counter = 0;
    ...
    <?php
              ...
              print '
              <div id="api_actions"></div>
              <div id="api_actions_mobile"></div>
            ...
            print '
                      <h1 class="entry-title title_prop">
                          '.__('[:en]No More Result[:km]គ្មានលទ្ធផលទៀតទេ[:]').'
                      </h1
                ';
                else
                print '
                <h1 class="entry-title title_prop api_display_none">
                '.__('[:en]No More Result[:km]គ្មានលទ្ធផលទៀតទេ[:]').'
                </h1
          ';                
    ...
    <?php
        $options['sidebar_name'] = 'primary-widget-area';
        $options['sidebar_class'] = 'col-md-3';    
