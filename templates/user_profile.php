        ...
        <div id="upload-container">                 
            <div id="aaiu-upload-container">
                <button id="aaiu-uploader" class="wpresidence_button wpresidence_success">
                    <?php _e('Upload  profile image.','wpestate');?>
                </button>
    ...
    <div class="col-md-8 dashboard_password">
        ...
        <p  class="col-md-6 input_container">
            ...
            <input id="renewpass" value=""  class="form-control" name="renewpass"type="password">
             <img src="<?php echo $icon;?>" forInput="renewpass"    class="input_img">
        </p>
