...
<div class="row">
    ...
    <div class=" <?php print esc_html($options['content_class']);?> full_width_prop">
        ...
        <span class="price_area"><?php wpestate_show_custom_price($post->ID); ?></span>
        ...
        <div class="notice_area">   
            <span class="adres_area"> Location: 
                <?php
             ...
             <span class="adres_area"> 
                ...
                <span>On: <?php echo get_the_date('Y-m-d'); ?> <span> 
    ...
    if (is_franchise()) {
        get_template_part('/templates/visitordetailpage/franchise/property_page_acc_content');
    } elseif (is_biz_for_sale()) {
    } else {
    }
    ?>    
