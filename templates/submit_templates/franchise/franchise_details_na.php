            ...
            <div class="row" >         
                    ...
                    <div class="col-md-6">
                            <p>
                                ...
                                <input type="text" id="average_staff" class="form-control" value="<?php echo esc_html($average_staff);?>"  name="average_staff">
                            </p>
                    </div>         
                    <div class="col-md-6">
                            <p>
                                <label for="royalty_fee"><?php _e('Royalty fee','wpestate');?></label>
                                <input type="text" id="royalty_fee" class="form-control" value="<?php echo esc_html($royalty_fee);?>"  name="royalty_fee">
                            </p>
                    </div>
                    <div class="col-md-12">
                            <p>
                                <label for="brand_logo"><?php _e('Brand Logo','wpestate');?></label>
                                <input type="text" id="brand_logo" class="form-control" value="<?php echo esc_html($brand_logo);?>"  name="brand_logo">
                            </p>
                    </div>
                     ...
                     <div class="col-md-12">
                            <p>
                                ...
                                <input type="text" id="docs" class="form-control" value="<?php echo esc_html($docs);?>"  name="docs">
                            </p>
                    </div>
                    <div class="col-md-12">
                            <p>
