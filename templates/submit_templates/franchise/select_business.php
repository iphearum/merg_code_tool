...
<?php if(   is_array($submission_page_fields) && 
           (    in_array('businesstype', $submission_page_fields) ||
                $custom_fields_show !=  ''
...
<div class="col-md-12 add-estate profile-page profile-onprofile row"> 
    <div class="submit_container">
        ...
        <div class="col-md-4 profile_label">
            <div class="user_details_row"><?php _e('Select Your Business','wpestate');?></div> 
            <div class="user_profile_explain"><?php _e('Please specify your business here. ','wpestate')?></div>
        </div>
        ...
        <div class="col-md-8">
            ...
            <div class="row" >          
             ...
             <div class="col-md-12">
                 <p class="">
                    <label for="businesstype"><?php _e('Business','wpestate');?></label>
            <?php
             $args=array(
                    'class'       => 'form-control',
                    'hide_empty'  => false,
