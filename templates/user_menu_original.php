...
<div class="user_tab_menu">
    ...
    <div class="user_dashboard_links">
        ...
        <?php } ?>
       <!--  <?php if( $add_link != $home_url && ! is_buyer() ){ ?>
            <a href="<?php print esc_url ($add_link);?>"      class="<?php print $activeadd; ?>"> <i class="fa fa-plus"></i><?php _e('Add New Property','wpestate');?></a>  
        <?php } ?> -->
         <?php if( $add_link != $home_url &&  is_biz_for_sale() ){ ?>
            <a href="<?php print esc_url ($add_link);?>"      class="<?php print $activeadd; ?>"> <i class="fa fa-plus"></i><?php _e('Add New Property','wpestate');?></a>  
        <?php } ?>
        <?php if( $add_link != $home_url &&  is_franchise() ){ ?>
            <a href="<?php print esc_url ($add_link);?>"      class="<?php print $activeadd; ?>"> <i class="fa fa-plus"></i><?php _e('Add New Property','wpestate');?></a>  
        <?php } ?>
         <?php if( $add_link != $home_url &&  is_administrator() ){ ?>
            <a  href="#" data-toggle="collapse" data-target="#demo"  class="<?php print $activeadd; ?>"> <i class="fa fa-plus"></i><?php _e('Add New Property ','wpestate');?><span class="pull-right"><i class="fa fa-caret-down"></i></span></a>  
                <ul id="demo" class="collapse" >
                    <li><a href="<?php print esc_url ($add_link);?>?type=franchise" > <i class="fa fa-plus"></i> &nbsp;Add Franchise </a></li>
                    <li> <a href="<?php print esc_url ($add_link);?>?type=biz_for_sale"><i class="fa fa-plus"></i> &nbsp; Add Biz  For Sale</a></li>
                </ul>
